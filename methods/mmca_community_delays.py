...
class MMCA():
    ...
    def update_epidemic_parameters(self, features_prob_tensor, epi_paras, soc_attention,\
    ...
    def update(self, features_prob_tensor, epi_paras, soc_attention, P_edge_index, I_edge_index, communities, obs = None):
...
if __name__ == "__main__":
    ...
    delays = 0
    start = time.time()
    features_times, _, _ = graph_dynamic_delays(time_scale, mmca, features_prob_tensor, epi_paras, soc_paras, P_edge_index, I_edge_index, communities, device, delays)
