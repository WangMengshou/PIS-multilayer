...
class MCMC():
    ...
    def update_epidemic_parameters(self, features_state_tensor, epi_paras, soc_paras, P_edge_index, I_edge_index, communities):
    ...
    def update(self, features_state_tensor, epi_paras, soc_paras, P_edge_index, I_edge_index, communities, obs = None):
...
if __name__ == "__main__":
  ...
  time_scale = 1000
  start = time.time()
  features_times, _ = graph_dynamic(time_scale, mcmc, features_state_tensor, epi_paras, soc_paras,\
